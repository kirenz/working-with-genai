...
**Datum der Durchläufe:** <Datum>

## Beobachtungen je Werkzeug

Je Kriterium ein kurzer Befund, kein Urteil. „Ja“ und „Nein“ genügen, wo es passt; sonst ein Satz.

| Kriterium | Prüffrage | Werkzeug 1: <Name, Konto frei/bezahlt> | Werkzeug 2: <Name, Konto> | Werkzeug 3: <Name, Konto> |
|---|---|---|---|---|
...
<Welche Teile des Ergebnisses waren in allen Werkzeugen inhaltlich gleich? Kandidaten: Preis, Bedingung, Struktur, sofern der Auftrag sie ausdrücklich verlangt hat.>

## Was sich unterschied

<Konkrete Unterschiede, jeweils mit Werkzeugname. Keine Bewertung, welches „besser“ war.>
...
<Eine Änderung, die aus den Beobachtungen folgt, etwa: „Offen“ als Pflichtabschnitt auch dann verlangen, wenn nichts offen ist; oder eine Rückfrage ausdrücklich ausschließen und stattdessen den Entwurf mit offenen Punkten verlangen.>

**Vorbehalt:** Ein Durchlauf je Werkzeug ist eine Beobachtung. Unterschiede können beim nächsten Durchlauf anders ausfallen. Das Protokoll begründet die nächste Fassung des Auftrags, nicht die Wahl eines Anbieters.
