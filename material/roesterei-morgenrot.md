# Rösterei Morgenrot: Ausgangslage und Team
...
Aylin Yılmaz führt das Unternehmen. Die vier übrigen Funktionen sind untereinander gleichrangig. Die Funktionen beschreiben Verantwortungsbereiche; daraus folgen keine Aussagen über Beschäftigungsumfang oder Personalkosten.

Zum weiteren Kreis gehören Tarek Amiri im Einkauf Rohkaffee und Ellen Ruppert in Lager und Versand. Bei offenen Lieferangaben ist Ellen die passende interne Ansprechpartnerin. Ihre Zuständigkeit ist noch kein Beleg für den Status einer bestimmten Bestellung.

## Das vorhandene Sortiment

| Sorte | Kategorie | Regulärer Listenpreis im Onlineshop |
|---|---|---|
| Espresso Intenso | Espresso | 10,00 Euro |
...
- Petra bereitet vorhandene Informationen für eine interne Besprechung auf und hält offene Angaben fest.
...
Die vollständigen Angaben zum Kopieren stehen in `lehrfall-fachinformationen.txt`, die Anfrage in `kundenanfrage.txt` und der Arbeitsauftrag in `prompt-vorlage.txt`.
